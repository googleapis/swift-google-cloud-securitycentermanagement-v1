...
///
/// [google.cloud.securitycentermanagement.v1.SecurityCenterManagement.CreateEventThreatDetectionCustomModule]: <doc:SecurityCenterManagementClient/createEventThreatDetectionCustomModule(request:)>
